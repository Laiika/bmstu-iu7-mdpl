...
main proc
    ...
    Dialog "lab11","MS Sans Serif",10, \         ; caption,font,pointsize
    ...
    DlgButton "End",WS_TABSTOP,112,15,30,10,IDCANCEL
    DlgStatic 'Click on "Test" to run',SS_CENTER,3,35,140,9,100
...
; обработка команд основного окна
